...
export default class DateSlider extends React.Component {
  ...
  render() {
    ...
    const difference_in_time = date_today.getTime() - date_of_first_case.getTime(); // TODO: Change this to set a limit on the end date
